...
var SubmitFormComponent = (function () {
    ...
    SubmitFormComponent.prototype.uploadChange = function (files) {
        console.log(this.fileSrcs);
        this.fileSrcs.push(window.URL.createObjectURL(files[0]));
        this.num = this.fileSrcs.length;
        console.log(this.num);
    };
    SubmitFormComponent.prototype.onSubmit = function () {
        var JsonForm = {
            "stuffName": this.stuffName,
            "stuffPrice": this.stuffPrice,
            "stuffDetail": this.stuffDetail,
            "stuffKind": this.stuffKind,
            "organization": this.organization,
            "telephone": this.telephone,
            "pictures": this.fileSrcs
        };
...
module.exports = "<h1>商品信息</h1>\n<div class=\"weui-cells weui-cells_form\">\n\t<div class=\"weui-uploader\">\n\t    <div class=\"weui-uploader__hd\">\n\t        <p class=\"weui-uploader__title\">商品图片</p>\n\t        <div class=\"weui-uploader__info\">0/2</div>\n\t    </div>\n\t    <div class=\"weui-uploader__bd\">\n\t        <ul class=\"weui-uploader__files\" id=\"uploaderFiles\" *ngIf=\"fileSrcs.length\">\n\t            <li class=\"weui-uploader__file\" *ngFor = \"let src of fileSrcs\"><img [src]=\"src\"></li>  \n\t        </ul>\n\t        <div class=\"weui-uploader__input-box\">\n\t            <input id=\"uploaderInput\" class=\"weui-uploader__input\" type=\"file\" accept=\"image/*\" multiple #uploadInput (change)=\"uploadChange(uploadInput.files)\"/>\n\t        </div>\n\t    </div>\n\t</div>\n    <div class=\"weui-cell\">\n        <div class=\"weui-cell__hd\"><label class=\"weui-label\">商品名称</label></div>\n        <div class=\"weui-cell__bd\">\n            <input class=\"weui-input\" type=\"text\" name=\"stuffName\" [(ngModel)]=\"stuffName\" placeholder=\"请输入商品名称\"/>\n        </div>\n    </div>\n    <div class=\"weui-cell\">\n        <div class=\"weui-cell__hd\"><label class=\"weui-label\">商品标价</label></div>\n        <div class=\"weui-cell__bd\">\n            <input class=\"weui-input\" type=\"number\" name=\"stuffPrice\" [(ngModel)]=\"stuffPrice\" placeholder=\"请输入商品价格\"/>\n        </div>\n    </div>\n\n \t<div class=\"weui-cell weui-cell_select weui-cell_select-after\">\n        <div class=\"weui-cell__hd\">\n            <label for=\"\" class=\"weui-label\">商品分类</label>\n        </div>\n        <div class=\"weui-cell__bd\">\n            <select class=\"weui-select\" name=\"select2\" [(ngModel)]=\"stuffKind\">\n                <option value=\"1\">电子用品</option>\n                <option value=\"2\">衣物</option>\n                <option value=\"3\">生活用品</option>\n            </select>\n        </div>\n    </div>\n<div class=\"weui-cells__title\">商品描述</div>\n    <div class=\"weui-cell\">\n        <div class=\"weui-cell__bd\">\n            <textarea class=\"weui-textarea\" name=\"stuffDeatil\" placeholder=\"请输入商品描述\" rows=\"3\" [(ngModel)]=\"stuffDetail\"></textarea>\n            <div class=\"weui-textarea-counter\"><span>0</span>/200</div>\n        </div>\n    </div>\n\n    <div class=\"weui-cells weui-cells_radio\">\n    <label class=\"weui-cell weui-check__label\" for=\"x11\">\n        <div class=\"weui-cell__bd\">\n            <p>是</p>\n        </div>\n        <div class=\"weui-cell__ft\">\n            <input type=\"radio\" class=\"weui-check\" name=\"radio1\" id=\"x11\">\n            <span class=\"weui-icon-checked\"></span>\n        </div>\n    </label>\n    <label class=\"weui-cell weui-check__label\" for=\"x12\">\n\n        <div class=\"weui-cell__bd\">\n            <p>否</p>\n        </div>\n        <div class=\"weui-cell__ft\">\n            <input type=\"radio\" name=\"radio1\" class=\"weui-check\" id=\"x12\" checked=\"checked\">\n            <span class=\"weui-icon-checked\"></span>\n        </div>\n    </label>\n</div>\n\n     <div class=\"weui-cell weui-cell_select weui-cell_select-after\">\n        <div class=\"weui-cell__hd\">\n            <label for=\"\" class=\"weui-label\">捐赠组织</label>\n        </div>\n        <div class=\"weui-cell__bd\">\n            <select class=\"weui-select\" name=\"select2\" [(ngModel)]=\"organization\">\n                <option value=\"1\">壹</option>\n                <option value=\"2\">贰</option>\n                <option value=\"3\">叁</option>\n                <option value=\"4\">其他</option>\n            </select>\n        </div>\n    </div>\n    <span class=\"weui-agree__text\">\n        你的买卖所得将捐赠给你选择的组织，感谢你的捐赠！\n    </span>\n\n<div class=\"weui-cells\">\n\n    <div class=\"weui-cell weui-cell_select weui-cell_select-before\">\n        <div class=\"weui-cell__hd\">\n            <select class=\"weui-select\" name=\"select2\" >\n                <option value=\"1\">+86</option>\n                <option value=\"2\">+80</option>\n                <option value=\"3\">+84</option>\n                <option value=\"4\">+87</option>\n            </select>\n        </div>\n        <div class=\"weui-cell__bd\">\n            <input class=\"weui-input\" type=\"number\" pattern=\"[0-9]*\" [(ngModel)]=\"telephone\" placeholder=\"请您输入号码，以便买家联系\"/>\n        </div>\n    </div>\n</div>\n\n<div class=\"weui-btn-area\">\n    <a class=\"weui-btn weui-btn_primary\" (click)=\"onSubmit()\" id=\"showTooltips\">确定</a>\n</div> \n</div>"
